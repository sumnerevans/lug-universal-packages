...
\begin{frame}{Advantages of each of these universal package formats}
    \begin{itemize}
        ...
        \item Nix is a cool functional package manager. 
        Everytime you build the same version of the same package you should get the same output
    \end{itemize}
\end{frame}
...
\begin{frame}{Pros and cons}
    ...
    \begin{itemize}
        ...
        \item More abstraction! No more dealing with a bunch of different
            packaging formats.
        \item Easier troubleshooting: Developers can be certain (ideally) that users are using the same software configuration
    \end{itemize}
    ...
    \begin{itemize}
        ...
        \item Library version management is somewhat delegated to the application developers, Windows style. Heartbleed anybody. This hopefully can be somewhat alleviated by runtimes
    \end{itemize}
\end{frame}
